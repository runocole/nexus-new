...
class AdsPayment(models.Model):
    id = models.UUIDField(primary_key=True)
    amount = models.IntegerField()
    created_at = models.DateTimeField(blank=True, null=True)
    reference = models.CharField(unique=True, max_length=100, blank=True, null=True)
    ...
    ad = models.ForeignKey(AdsAd, models.DO_NOTHING, blank=True, null=True)
    owner = models.ForeignKey('AuthenticationUser', models.DO_NOTHING)
    shop = models.ForeignKey('ShopShop', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'ads_payment'
...
class AuthenticationPasswordresettoken(models.Model):
    id = models.UUIDField(primary_key=True)
...
class ShopShop(models.Model):
    ...
    owner = models.ForeignKey(AuthenticationUser, models.DO_NOTHING, blank=True, null=True)
